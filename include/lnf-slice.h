...
lnf_slice *make_slice_from_len (size_t s, size_t len);
lnf_slice *make_slice_from_len_and_cap (size_t s, size_t len, size_t cap);

lnf_slice *make_slice_from_array (void *arr, size_t arrsize);
...
lnf_slice *lnf_slice_slice_array (void *arr, size_t size_of_type,
                                  size_t start, size_t end);

lnf_slice *lnf_slice_slice_array_head (void *arr, size_t size_of_type,
                                       size_t end);

lnf_slice *lnf_slice_slice_array_tail (void *arr, size_t size_of_type,
                                       size_t start);
